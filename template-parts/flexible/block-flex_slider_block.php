  ...
  <div class="container flex-slider-block__slider slider-block">
       <?php foreach( $slider as $slide ) : 
        ...
        <?php if( is_array( $slide ) && !empty( $slide ) && !empty( $slide_image ) ) : ?>
           <div class="row d-flex align-items-center justify-content-start slider-block__slide">
               <?php if( !empty( $slide_title ) || !empty( $slide_title ) ) : ?>
               <div class="col-12 col-lg-9 slider-block__slide__title">
       ...
       <?php if( $block_title && !empty($block_title) ) : ?>
          <div class="p-absolute ml-auto mr-auto flex-slider-block__slider__title">
