...
<div class="row">
  ...
  if( !empty( $image ) ) : ?>
    <div class="col-12 col-md-6 col-xl-5 woo-product__data__image pl-0">
      <?php wc_get_template( 'single-product/product-image.php' ); ?>
    </div>
  <?php endif; ?>
  
  <div class="col-12 col-md-6 col-xl-7 woo-product__data__additional pr-0">
    <div class="row">
     <div class="col-12">
  ...
  <div class="col-12 woo-product__data__meta p-0">
    <?php wc_get_template( 'single-product/meta.php' ); ?>
  </div>
  
  <div class="col-12 woo-product__data__main pr-0 pl-0">
    <?php
    /**
              ...
              <div class="woo-product__data__faq__card row">
                <?php if( !empty( $question ) ) : ?>
                  <div class="col-12 pl-0 pr-0 m-0 card-header product-title" id="heading-<?php echo $counter; ?>">
                    <button class="btn btn-link p-0" data-toggle="collapse" data-target="#collapse-<?php echo $counter; ?>" aria-expanded="true" aria-controls="collapse-<?php echo $counter; ?>">
                      <?php echo $question; ?>
                    </button>
                  </div>
                <?php endif;
                ...
                <div id="collapse-<?php echo $counter; ?>" class="collapse <?php echo ( $counter === 1 ) ? 'show' : ''; ?> col-12 pl-0 pr-0 m-0" aria-labelledby="heading-<?php echo $counter; ?>" data-parent="#accordion">
                  <div class="card-body w-100 pr-0 pl-0">
                    <?php echo $answer; ?>
                  </div>
                </div>
                <?php endif; ?>
